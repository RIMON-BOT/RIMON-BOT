...
8
      ...
      msg += `\n𝘾𝙪𝙧𝙧𝙚𝙣𝙩𝙡𝙮, 𝙏𝙝𝙞𝙨 𝙗𝙤𝙩 𝙝𝙖𝙫𝙚  ${totalCommands} 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀 𝘁𝗵𝗮𝘁 𝗰𝗮𝗻 𝗯𝗲 𝘂𝘀𝗲𝗱. 𝗦𝗼𝗼𝗻 𝗺𝗼𝗿𝗲 𝗰𝗼𝗺𝗺𝗮𝗻𝗱𝘀 𝘄𝗶𝗹𝗹 𝗯𝗲 𝗮𝗱𝗱𝗲𝗱\n`;
      msg += `𝙏𝙮𝙥𝙚 ${prefix} 𝗛𝗲𝗹𝗽 𝗰𝗼𝗺𝗺𝗮𝗻𝗱 𝗡𝗮𝗺𝗲 𝘁𝗼 𝘃𝗶𝗲𝘄 𝘁𝗵𝗲 𝗱𝗲𝘁𝗮𝗶𝗹𝘀 𝗼𝗳 𝘁𝗵𝗮𝘁 𝗰𝗼𝗺𝗺𝗮𝗻𝗱\n`;
      msg += `𝗙𝗢𝗥 𝗔𝗡𝗬 𝗛𝗘𝗟𝗣 𝗜𝗡𝗙𝗢𝗥𝗠𝗔𝗧𝗜𝗢𝗡 𝗖𝗢𝗡𝗧𝗥𝗔𝗖𝗧 𝗢𝗪𝗡𝗘𝗥 𝗠𝗥 𝗥𝗜𝗠𝗢𝗡`;
